        ...
        try{
            ...
            for(int temp = 0; temp < nList.getLength(); temp++){
                ...
                if(nNode.getNodeType() == Node.ELEMENT_NODE){
                    ...
                    System.out.println(temp+1 + ", 산명 : " + getTagValue("mntiname", eElement) + ", 산정보소재지 : " + getTagValue("mntiadd", eElement) + ", 산정보높이 : " + getTagValue("mntihigh", eElement)+", 산정보  : " + getTagValue("mntidetails", eElement));
